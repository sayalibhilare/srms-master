...
<?php
     if(isset($_POST['class_name'],$_POST['p1'],$_POST['p2'],$_POST['p3'],$_POST['p4'],$_POST['p5'],$_POST['p6'])) 
    {
        $rno=$_POST['rno'];
        ...
        // validation
        if (empty($class_name) or empty($rno) or $p1>100 or  $p2>100 or $p3>100 or $p4>100 or $p5>100 or $p6>100 or $p1<0 or  $p2<0 or $p3<0 or $p4<0 or $p5<0 or $p6<0 ) {
            if(empty($class_name))
            ...
            if($p1>100 or  $p2>100 or $p3>100 or $p4>100 or $p5>100 or $p6>100 or $p1<0 or  $p2<0 or $p3<0 or $p4<0 or $p5<0 or $p6<0) 
                echo '<p class="error">Please enter valid marks</p>';
            exit();
        }
